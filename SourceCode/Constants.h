...
#ifdef _DEBUG
static const std::wstring __FSACVersion = L"0.2 (debug)";
#else
static const std::wstring __FSACVersion = L"0.2";
#endif

static const std::wstring __FSACDate = L"October 5th 2022";

enum class SpecialMode { None = 0, GA = 1, JetAirliners = 2, Twins = 3, Props = 4, TurboProps = 5 };

static const int kContinentCount = 7;

static const std::wstring ContinentNames[kContinentCount] = { L"Africa", L"Antarctica", L"Asia", L"Europe", L"North America", L"Oceania", L"South America" };
static const std::wstring ContinentShort[kContinentCount] = { L"AF", L"AN", L"AS", L"EU", L"NA", L"OC", L"SA" };

static const int kISOCountries = 249;

static const std::wstring ISOCountries[kISOCountries][2] =
{ { L"AD", L"Andorra"},
